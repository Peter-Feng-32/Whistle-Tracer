...
sample_rate, samples = wavfile.read('denise1.wav') # load the data
...
f1 = plt.figure(1)
plt.imshow(spectrogram[LOWEST_FREQ_BIN:HIGHEST_FREQ_BIN])
...
plt.title("Heavy Masked Results(comp 10 bins)")
plt.ylabel('Freq ')
plt.xlabel('Time')
